...
from src.models.train_base_model import DATA_FILE, LABEL, time_split_holdout
...
def parse_args():
    ...
    parser.add_argument("--model-path", type=str, default=str(MODEL_DIR / "catboost_v1.joblib"))
    parser.add_argument("--meta-path", type=str, default=str(MODEL_DIR / "catboost_v1_meta.json"))
