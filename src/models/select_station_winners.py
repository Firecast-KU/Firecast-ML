...
from src.config.paths import DATASET_DIR, MODEL_DIR, ROOT
...
DEFAULT_MODELS = {
    "lr": {
        "model_path": MODEL_DIR / "base_lr.joblib",
        "meta_path": MODEL_DIR / "base_lr_meta.json",
        "type": "wide",
    },
    "catboost": {
        "model_path": MODEL_DIR / "catboost_v1.joblib",
        "meta_path": MODEL_DIR / "catboost_v1_meta.json",
        "type": "wide",
    },
    "tcn": {
        "model_path": MODEL_DIR / "tcn_v1.pt",
        "meta_path": MODEL_DIR / "tcn_v1_meta.json",
        "type": "tcn",
    },
}
