...
from src.config.paths import DATASET_DIR, TCN_ARTIFACT_DIR
...
def parse_args():
    ...
    parser.add_argument("--model-path", type=str, default=str(TCN_ARTIFACT_DIR / "tcn_v1.pt"))
    parser.add_argument("--meta-path", type=str, default=str(TCN_ARTIFACT_DIR / "tcn_v1_meta.json"))
